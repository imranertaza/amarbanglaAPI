...
class GlobalAddressController extends Controller
{
    ...
    private array $district_list = array(
    ...
    private array $pourashova_Union = ['1' => 'Pourashava', '2' => 'Union'];
     ...
     *
     * This endpoint returns a list of all available divisions.
     *
     * @response 200 {
     *   "data": [
     *     {"id": 1, "name": "Dhaka"},
     ...
     *
     * @response 404 {
     *   "data": "No Division found",
     *   "status": 404
     * }
     *
     * @return JsonResponse A JSON response containing either the list of divisions (200)
    ...
    /**
     * Retrieve districts by division ID
     *
     * This endpoint returns the list of districts belonging to a given division.
     *
     * @urlParam divisionID int required The ID of the division to filter districts by.
     *
     * @response 200 {
     *   "data": [
     *     {"id": 1, "name": "Khulna"},
     ...
     *
     * @response 404 {
     *   "data": "No District found",
     *   "status": 404
     * }
     *
     * @param int $divisionID The division ID used to filter districts.
     * @return JsonResponse A JSON response containing either the list of districts (200)
     *                      or an error message if none are found (404).
     */
    ...
    /**
     * Retrieve subdistricts by district ID
     *
     * This endpoint returns the list of subdistricts belonging to a given district.
     *
     * @urlParam districtID int required The ID of the district to filter subdistricts by.
     *
     * @response 200 {
     *   "data": [
     *     {"id": 1, "name": "Subdistrict A"},
     *     {"id": 2, "name": "Subdistrict B"}
     *   ],
     *   "status": 200
     * }
     *
     * @response 404 {
     *   "data": "No Sub District found",
     *   "status": 404
     * }
     *
     * @param int $districtID The district ID used to filter subdistricts.
     * @return JsonResponse A JSON response containing either the list of subdistricts (200)
     *                      or an error message if none are found (404).
     */
    ...
    /**
     * Retrieve all Pourashova or Union names
     *
     * This endpoint returns the list of all available Pourashova or Union names.
     *
     * @response 200 {
     *   "data": [
     *     {"id": 1, "name": "Pourashova A"},
     *     {"id": 2, "name": "Union B"}
     *   ],
     *   "status": 200
     * }
     *
     * @response 404 {
     *   "data": "No Pourashova or Union found",
     *   "status": 404
     * }
     *
     * @return JsonResponse A JSON response containing either the list of Pourashova/Union names (200)
     *                      or an error message if none are found (404).
     */
    ...
    /**
     * Retrieve all Ward names
     *
     * This endpoint returns the list of all available Wards.
     *
     * @response 200 {
     *   "data": [
     *     {"id": 1, "name": "Ward A"},
     ...
     * }
     *
     * @return JsonResponse A JSON response containing either the list of Wards (200)
     *                      or an error message if none are found (404).
     */
     ...
     * Retrieve districts by division ID
     *
     * This endpoint returns a list of districts belonging to a given division.
     * You can optionally limit the number of results and control sorting.
     *
     * @urlParam division int required The division ID to filter districts by.
     * @queryParam limit int optional The maximum number of districts to retrieve. Default is 0 (no limit).
     * @queryParam orderBy string optional The column to order results by. Default is 'global_address_id'.
     ...
     * }
     *
     * @param int $division The division ID used to filter districts.
     ...
     * @param string $orderType (optional) The order type ('ASC' or 'DESC'). Default is 'ASC'.
     *
     * @return JsonResponse A JSON response containing either the list of districts (200)
     *                      or an error message if none are found (404).
     */
    ...
    /**
     * @description This function is used as a callback function that returns a array after adding the district name with the given array
     * @param $result
     * @return array
     */
    private function add_district_name($result): array
    {
        return array_map(function ($element) {
            $districtID = $element->zila;
            foreach ($this->district_list as $district) {
